...
[解答](https://zhangchenchengsjtu.github.io/MATH1205H-04-HW/assets/PDF/2025-09-30-solu-%E7%A7%A9%E4%B8%8D%E7%AD%89%E5%BC%8F.pdf) 中的刊误:

Page 6, Line 9

- Original: 1. 依分块矩阵计算 $ABA=A$, 得 $B11=O$;
- Corrected: 1. 依分块矩阵计算 $ABA=A$, 得 $B_{11}=I$;

Page 7, Line 10

- Original: 最后 $r(M)=r(A)+r(D−CA^\dagger B^{-1})$.
- Corrected: 最后 $r(M)=r(A)+r(D−CA^\dagger B)$.
